...
#   1. MIKROS_LOC_BUDGET environment variable
#   2. loc_budget field in .mikros/STATE.md
#   3. Default of 300
...
BUDGET="${MIKROS_LOC_BUDGET:-}"

# 2. Fall back to .mikros/STATE.md if env var not set.
if [ -z "$BUDGET" ]; then
